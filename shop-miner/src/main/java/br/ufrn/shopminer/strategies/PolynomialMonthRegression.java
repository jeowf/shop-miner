/**
 * Código adaptado de: https://algs4.cs.princeton.edu/14analysis/PolynomialRegression.java.html
 */
...
public class PolynomialMonthRegression implements Comparable<PolynomialMonthRegression> , Strategy{
     ...
     *
     * @param  prices the corresponding values of the response variable
     ...
     * @throws IllegalArgumentException if the lengths of the two arrays are not equal
     */
    public void initialize(double[] x, double[] y, int degree, String variableName) {
        this.degree = degree;
     ...
     *    variable {@code x}.
     *
     * @param  date the date value of the predictor variable
     * @return the expected response {@code y} given the value of the predictor
     *         variable {@code x}
     */
    @Override
    public double predict(Date date) {
        double x = date.getDay();
        // horner's method
        double y = 0.0;
